...
<body>
    <main>
        ...
        //             elseif($imc <= 24.9) $faixa = 'Normal';
        //             elseif($imc <= 29.9) $faixa = 'Sobrepeso';

        //         echo '<p><strong>Faixa</strong>:'. $faixa . '</p>';
        //         break;

        //     case 'tmb':
        //         $tmb = calcularTMB($genero, $peso, $idade, $altura);
        //         if ($tmb !== null){ echo '<p>Você gasta aproximadamente ' . number_format($tmb, 2, ',', '.') . 'kcal/dia </p>'
        //         } else(){
        //              echo '<p>Gênero não selecionado corretamente</p> ';
        //             }
        //     break;
