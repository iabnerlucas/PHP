...
$texto = '<h1>texto para se resumir vindo de uma variável</h1>';
$texto = strip_tags($texto); // Remove todas as tags HTML do texto

echo formatarValor(123.99); // Exibe o valor formatado com 2 casas decimais, vírgula como separador decimal e ponto como separador de milhar
 echo '<br>';
 echo '<br>';
